...
def train(inputs, targets, embedding_matrix, batch_size=BATCH_SIZE, epoch_count=100, max_length=MAX_LENGTH, model_filepath="../model/cnn_model2.h5", learning_rate=0.001):
...
if __name__ == "__main__":
    ...
    plt.savefig("../result/model2_cnn_loss.png")
    history_df.loc[:,['val_accuracy','accuracy']].plot()
    plt.savefig("../result/model2_cnn_accuracy.png")